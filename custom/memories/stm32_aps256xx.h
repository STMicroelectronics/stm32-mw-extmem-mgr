/**
  ...
  * @brief   This file contains configuration details for support of the APMemory APS256XXN-OBRx DDR Octal SPI PSRAM,
...
/* CMD1: MA0 register: Command to set Latency Not Fixed, Read Latency to 7 and Drive Strength to 50 Ohms */
...
#define EXTMEM_APS256XX_CMD1_VALUE_CFG2          0x11      /*!< Value of the register -> Latency not Fixed */
...
/* CMD3: MA8 register: Command to set x16 Mode */
...
#define EXTMEM_APS256XX_HEXA_CMD_READ            0x00      /*!< Command to read data : Sync Read */
...
#define EXTMEM_APS256XX_INIT { \
                                   ...
                                   .MemStandard                              = EXTMEM_CUSTOM_STD_APMEM_16BITS,        /*!< Mem Standard e.g., Macronix, Micron, etc. */  \
                                   ...
                                   .PsramConfig.Refresh                      = 30,                                 /*!< Refresh rate */ \
                                   }
