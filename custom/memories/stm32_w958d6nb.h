/**
  ******************************************************************************
  * @file    stm32_w958d6nb.h
  * @author  MCD Application Team
  * @brief   This file contains configuration details for support of the Windbond W958D6NB HyperRAM memory,
...
#ifndef __STM32_W958D6NB__H__
#define __STM32_W958D6NB__H__
...
#define EXTMEM_W958D6NB_CMD1_ADDR_CFGR           0x1000    /*!< Address of the register */
#define EXTMEM_W958D6NB_CMD1_VALUE_CFGR          0x7000    /*!< Value of the register [14-12] = 110b (19 ohms) */
#define EXTMEM_W958D6NB_CMD1_MASK_CFGR           0x7000    /*!< Mask for the register [14-12] */
...
#define EXTMEM_W958D6NB_INIT { \
                               ...
                               .StartupConfig.AccessMode                              = EXTMEM_CUSTOM_8D_8D_16D,               /*!< Access mode (e.g., 1S4D4D) */ \
                               ...
                               .RegisterConfig[0].RWConfigStep.RegisterAddress        = EXTMEM_W958D6NB_CMD1_ADDR_CFGR,        /*!< Address of the register */ \
                               .RegisterConfig[0].RWConfigStep.RegisterValue          = EXTMEM_W958D6NB_CMD1_VALUE_CFGR,       /*!< Value of the register */ \
                               .RegisterConfig[0].RWConfigStep.RegisterMask           = EXTMEM_W958D6NB_CMD1_MASK_CFGR,        /*!< Mask for the register */ \
                               ...
                               .HyperRamConfig.HyperbusConfig.RwRecoveryTimeCycle     = 7,                                     /*!< Read/Write recovery time cycle */ \
                               .HyperRamConfig.HyperbusConfig.AccessTimeCycle         = 7,                                     /*!< Access time cycle */ \
...
#if defined(EXTMEM_C)
EXTMEM_DRIVER_CUSTOM_ObjectTypeDef extmem_w958d6nb = EXTMEM_W958D6NB_INIT;
#else
extern EXTMEM_DRIVER_CUSTOM_ObjectTypeDef extmem_w958d6nb;
#endif /* EXTMEM_C */
