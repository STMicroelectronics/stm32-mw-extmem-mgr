...
This **stm32-mw-extmem-mgr** MCU component repository is one element **common to all** STM32Cube MCU embedded software packages, providing the **External Memory Middleware** part.
...
Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32-mw-extmem-mgr/blob/main/Release_Notes.html).
